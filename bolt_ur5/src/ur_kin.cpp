...
void forward(const double* q, double* T)
{
  ...
  *T = (-(c6 * ((s1 * c234 + c1 * s234) - (s1 * c234 - c1 * s234))) / 2.0 -
  ...
  T++;
  *T = ((ur_kin_d5 * (s1 * c234 - c1 * s234)) / 2.0 - (ur_kin_d5 * (s1 * c234 + c1 * s234)) / 2.0 - ur_kin_d4 * s1 +
        (ur_kin_d6 * (c1 * c234 - s1 * s234) * s5) / 2.0 + (ur_kin_d6 * (c1 * c234 + s1 * s234) * s5) / 2.0 -
        ur_kin_a2 * c1 * c2 - ur_kin_d6 * c5 * s1 - ur_kin_a3 * c1 * c2 * c3 + ur_kin_a3 * c1 * s2 * s3);
  T++;
  ...
  *T = ((ur_kin_d5 * (c1 * c234 - s1 * s234)) / 2.0 - (ur_kin_d5 * (c1 * c234 + s1 * s234)) / 2.0 + ur_kin_d4 * c1 +
        (ur_kin_d6 * (s1 * c234 + c1 * s234) * s5) / 2.0 + (ur_kin_d6 * (s1 * c234 - c1 * s234) * s5) / 2.0 +
        ur_kin_d6 * c1 * c5 - ur_kin_a2 * c2 * s1 - ur_kin_a3 * c2 * c3 * s1 + ur_kin_a3 * s1 * s2 * s3);
  T++;
  ...
  *T = (ur_kin_d1 + (ur_kin_d6 * (c234 * c5 - s234 * s5)) / 2.0 + ur_kin_a3 * (s2 * c3 + c2 * s3) + ur_kin_a2 * s2 -
        (ur_kin_d6 * (c234 * c5 + s234 * s5)) / 2.0 - ur_kin_d5 * c234);
  T++;
  *T = 0.0;
  T++;
  *T = 0.0;
...
void forward_all(const double* q, double* T1, double* T2, double* T3, double* T4, double* T5, double* T6)
{
  ...
  if (T3 != NULL)
  {
    ...
    *T3 = s1;
    T3++;
    *T3 = c1*(ur_kin_a3 * c23 + ur_kin_a2 * c2);
    T3++;
    *T3 = c23* s1;
    T3++;
    *T3 = -s23* s1;
    ...
    *T3 = -c1;
    T3++;
    *T3 = s1*(ur_kin_a3 * c23 + ur_kin_a2 * c2);
    T3++;
    *T3 = s23;
    T3++;
    *T3 = c23;
    ...
    *T3 = 0;
    T3++;
    *T3 = ur_kin_d1 + ur_kin_a3* s23 + ur_kin_a2* s2;
    T3++;
    *T3 = 0;
    T3++;
    *T3 = 0;
  ...
  if (T4 != NULL)
  {
    ...
    *T4 = s234* c1;
    T4++;
    *T4 = c1*(ur_kin_a3 * c23 + ur_kin_a2 * c2) + ur_kin_d4 * s1;
    T4++;
    *T4 = c234* s1;
    T4++;
    *T4 = -c1;
    ...
    *T4 = s234* s1;
    T4++;
    *T4 = s1*(ur_kin_a3 * c23 + ur_kin_a2 * c2) - ur_kin_d4 * c1;
    T4++;
    *T4 = s234;
    T4++;
    *T4 = 0;
    ...
    *T4 = -c234;
    T4++;
    *T4 = ur_kin_d1 + ur_kin_a3* s23 + ur_kin_a2* s2;
    T4++;
    *T4 = 0;
    T4++;
    *T4 = 0;
  ...
  if (T5 != NULL)
  {
    ...
    *T5 = c5* s1 - c234* c1* s5;
    T5++;
    *T5 = c1*(ur_kin_a3 * c23 + ur_kin_a2 * c2) + ur_kin_d4 * s1 + ur_kin_d5 * s234 * c1;
    T5++;
    *T5 = c234* c5* s1 - c1* s5;
    T5++;
    *T5 = -s234* s1;
    ...
    *T5 = -c1* c5 - c234* s1* s5;
    T5++;
    *T5 = s1*(ur_kin_a3 * c23 + ur_kin_a2 * c2) - ur_kin_d4 * c1 + ur_kin_d5 * s234 * s1;
    T5++;
    *T5 = s234* c5;
    T5++;
    *T5 = c234;
    ...
    *T5 = -s234* s5;
    T5++;
    *T5 = ur_kin_d1 + ur_kin_a3* s23 + ur_kin_a2* s2 - ur_kin_d5* c234;
    T5++;
    *T5 = 0;
    T5++;
    *T5 = 0;
  ...
  if (T6 != NULL)
  {
    ...
    *T6 = c5* s1 - c234* c1* s5;
    T6++;
    *T6 = ur_kin_d6*(c5 * s1 - c234 * c1 * s5) + c1 * (ur_kin_a3 * c23 + ur_kin_a2 * c2) + ur_kin_d4 * s1 +
          ur_kin_d5 * s234 * c1;
    T6++;
    ...
    *T6 = -c1* c5 - c234* s1* s5;
    T6++;
    *T6 = s1*(ur_kin_a3 * c23 + ur_kin_a2 * c2) - ur_kin_d4 * c1 - ur_kin_d6 * (c1 * c5 + c234 * s1 * s5) +
          ur_kin_d5 * s234 * s1;
    T6++;
    ...
    *T6 = -s234* s5;
    T6++;
    *T6 = ur_kin_d1 + ur_kin_a3* s23 + ur_kin_a2* s2 - ur_kin_d5* c234 - ur_kin_d6* s234* s5;
    T6++;
    *T6 = 0;
    T6++;
    *T6 = 0;
...

  {
    for (int i = 0; i < 2; i++)
    {
      for (int j = 0; j < 2; j++)
      {
        ...
        double p13x = ur_kin_d5 * (s6 * (T00 * c1 + T10 * s1) + c6 * (T01 * c1 + T11 * s1)) -
                      ur_kin_d6 * (T02 * c1 + T12 * s1) + T03 * c1 + T13 * s1;
        double p13y = T23 - ur_kin_d1 - ur_kin_d6 * T22 + ur_kin_d5 * (T21 * c6 + T20 * s6);

        double c3 =
            (p13x * p13x + p13y * p13y - ur_kin_a2 * ur_kin_a2 - ur_kin_a3 * ur_kin_a3) / (2.0 * ur_kin_a2 * ur_kin_a3);
...
int main(int argc, char* argv[])
{
  ...
  for (int i = 0; i < num_sols; i++)
    printf("%1.6f %1.6f %1.6f %1.6f %1.6f %1.6f\n", q_sols[i * 6 + 0], q_sols[i * 6 + 1], q_sols[i * 6 + 2],
